      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        @media(max-width:760px){
          ...
          .intro{padding:64px 0}.intro h2,.featureHeading h2,.faqHeading h2,.realChatHeading h2,.installCopy h2{font-size:32px}.handCopy{font-size:18px;white-space:nowrap}
          ...
          .sceneIntro,.features,.faqSection{width:calc(100% - 36px);padding:64px 0}.sceneIntro h2{font-size:34px}.sceneSection{width:calc(100% - 22px)}.scene{display:flex;flex-direction:column;gap:22px;margin-bottom:56px}.scene.reverse .sceneImageWrap{order:initial}.sceneCopy{width:100%;padding:3px 9px}.sceneCopy h2{font-size:31px}
