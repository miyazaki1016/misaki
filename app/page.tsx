    ...
    <>
      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .finalSection{padding:25px 18px 90px}.finalVisual{position:relative;width:min(1080px,100%);min-height:900px;margin:auto;overflow:hidden;border-radius:36px;background:#f8efea;box-shadow:0 24px 60px rgba(86,58,68,.1)}.finalImage{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center 35%}.finalShade{position:absolute;inset:0;background:linear-gradient(180deg,rgba(255,250,249,0) 0%,rgba(255,250,249,0) 50%,rgba(255,250,249,.78) 72%,#fffafa 88%)}.finalHand{position:absolute;z-index:2;top:42px;left:55px;color:var(--main-dark);font-family:"Yu Mincho",serif;font-size:38px;line-height:1.5;transform:rotate(-6deg)}.finalCopy{position:absolute;z-index:2;left:55px;right:55px;bottom:46px}.finalCopy h2{margin:0;color:var(--title);font-size:58px;line-height:1.3}.finalCopy h2 span{color:var(--main-dark)}.finalCopy>p:not(.eyebrow,.heroNote){font-size:18px;line-height:1.8}.finalCopy .mainCta{width:min(570px,100%)}
        ...
        @media(max-width:760px){
          ...
          .hero{padding:0 8px}.heroVisual{min-height:830px;border-radius:26px}.heroImage{height:64%;object-position:center top}.heroShade{background:linear-gradient(180deg,transparent 0%,transparent 35%,rgba(255,250,249,.25) 51%,rgba(255,250,249,.93) 64%,#fffafa 76%)}.heroCopy{position:absolute;left:0;right:0;bottom:0;width:auto;padding:0 24px 28px}.hero h1{font-size:36px}.heroLead{font-size:16px}.mainCta,.profileCta{width:100%;font-size:18px}
          ...
          .finalSection{padding:0 0 60px}.finalVisual{width:100%;min-height:1010px;border-radius:0;box-shadow:none}.finalImage{height:74%;object-position:center top}.finalShade{background:linear-gradient(180deg,transparent 0%,transparent 46%,rgba(255,250,249,.2) 56%,rgba(255,250,249,.87) 69%,#fffafa 79%,#fffafa 100%)}.finalHand{top:26px;left:38px;font-size:29px;line-height:1.5}.finalCopy{left:30px;right:30px;bottom:28px}.finalCopy h2{font-size:43px;line-height:1.28}.finalCopy>p:not(.eyebrow,.heroNote){font-size:17px;line-height:1.8}.finalCopy .mainCta{width:100%;min-height:68px;font-size:20px;border-radius:19px}
