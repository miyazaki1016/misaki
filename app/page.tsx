    ...
    <>
      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .profileMobileComposite{display:none}.profileDesktop{display:block}.profileSection{padding:40px 20px 110px;background:linear-gradient(180deg,#fffafa,#f8efea)}
        ...
        @media(max-width:760px){
          ...
          .intro{padding:64px 0}.intro h2,.featureHeading h2,.faqHeading h2,.realChatHeading h2,.installCopy h2{font-size:clamp(27px,7.3vw,31px);line-height:1.48;letter-spacing:-.025em;overflow-wrap:normal;word-break:keep-all}.intro h2 br{display:none}.handCopy{font-size:18px;white-space:nowrap}
          .profileSection{padding:18px 0 56px;background:#fffafa}.profileMagazine{width:100%;border-radius:0;box-shadow:none}.profileDesktop{display:none}.profileMobileComposite{display:block;width:100%;height:auto}.profileFacts,.profileBottom{display:none}
          .sceneIntro,.features,.faqSection{width:calc(100% - 36px);padding:64px 0}.sceneIntro h2{font-size:clamp(30px,8.2vw,33px);line-height:1.42;letter-spacing:-.025em;word-break:keep-all}.sceneSection{width:calc(100% - 22px)}.scene{display:flex;flex-direction:column;gap:22px;margin-bottom:56px}.scene.reverse .sceneImageWrap{order:initial}.sceneCopy{width:100%;padding:3px 9px}.sceneCopy h2{font-size:31px}
          .installSection,.realChatSection{padding:64px 18px}.installInner,.realChatInner{display:flex;flex-direction:column;gap:30px}.installLead,.realChatHeading>p:last-child{font-size:17px}
