      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        @media(max-width:760px){
          ...
          .hero{padding:0}.heroVisual{min-height:0;height:calc(100svw * 1.36);max-height:980px;border-radius:26px}.heroImage{height:100%;object-position:center top}.heroShade{background:linear-gradient(180deg,transparent 0%,transparent 48%,rgba(255,250,249,.08) 55%,rgba(255,250,249,.68) 65%,rgba(255,250,249,.94) 76%,#fffafa 88%,#fffafa 100%)}.heroCopy{position:absolute;left:0;right:0;bottom:0;width:auto;padding:0 36px 34px}.heroSmall{font-size:15px;padding:7px 16px}.hero h1{font-size:clamp(38px,7.2vw,52px);line-height:1.23}.heroLead{font-size:clamp(17px,3.3vw,22px);line-height:1.7}.hero .mainCta{width:100%;min-height:74px;font-size:20px;border-radius:22px}.heroNote{font-size:12px}.profileCta{width:100%;font-size:18px}
